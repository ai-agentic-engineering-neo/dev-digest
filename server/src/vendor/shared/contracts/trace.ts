...
export const RunStats = z.object({
  ...
  /** Run cost in USD, snapshotted at completion; null/absent when unknown (older traces, failed runs). */
...
export const RunSummary = z.object({
  ...
  /** Run cost in USD; null when unknown (pre-feature, unpriced model, failed/cancelled). */
