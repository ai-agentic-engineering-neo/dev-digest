...
Durable findings for `@devdigest/reviewer-core`: things that are true about this code
but not visible in it. Recorded by agents at the end of a non-trivial task, per
