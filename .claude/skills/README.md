...
| [onion-architecture](onion-architecture/SKILL.md) | Backend | Layered routes→service→repository dependency-inward architecture for Fastify/Drizzle modules |
| [next-best-practices](next-best-practices/SKILL.md) | Frontend | Next.js App Router, RSC boundaries, data fetching, optimization |
| [react-best-practices](react-best-practices/SKILL.md) | Frontend | React anti-patterns, state management, hooks rules |
| [frontend-architecture](frontend-architecture/SKILL.md) | Frontend | UI architecture — component/constants/utils/business-logic placement |
