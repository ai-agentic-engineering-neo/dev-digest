 ...
 *
 * This is the Part-0 starter set plus skills. Each later course lesson adds
 * its own module here (intent/smart-diff, blast, brief/context/onboarding,
 * eval/ci/hooks, memory, plugins, …) without touching any other module or the
 * shared schema.
 */
