...
// --- Walk / parse scope -----------------------------------------------------
/** [T1] Files we parse (diff-scoped in T1; whole walk in T2). Owned by src/domain (adapters use it too). */
export { SUPPORTED_EXT } from '../../domain/source-scope.js';
...
export { MAX_SIGNATURE_CHARS } from '../../domain/source-scope.js';
