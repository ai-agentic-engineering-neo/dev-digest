...
- **Skills** (L02) — reusable, text-only review rules at `/skills`: create, import a `.md`/`.zip` with a preview, edit with versioning, attach and order per agent; rendered into the prompt under `## Skills / rules` (`docs/skills/`).
