/* SkillCard — one skill in the /skills grid: type icon + badge, name,
   description, source, enabled switch (optimistic), linked agents and the
   pull % · accept % from GET /skills/stats. Click opens the preview drawer. */
"use client";
