...
import { CONFIDENCE_OK, CONFIDENCE_WARN, FILTER_STATUSES, type ConventionFilter } from "./constants";
...
/** Bar colour for a confidence score — same bands the findings UI uses. */
