...
| [onion-architecture](onion-architecture/SKILL.md) | Backend | Onion Architecture for server + reviewer-core: rings ↔ files, dependency rule, Fastify/Drizzle/Zod/SDK placement, enforced by `pnpm arch` |
