...
Deeper reference material for `e2e` that doesn't belong in [`../CLAUDE.md`](../CLAUDE.md) (too detailed/stable to re-read every session) or in [`../README.md`](../README.md) (too deep for a human-facing overview).
