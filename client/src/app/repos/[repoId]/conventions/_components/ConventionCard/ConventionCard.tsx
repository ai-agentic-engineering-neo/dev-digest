...
import { Badge, Button, Checkbox, Icon, IconBtn, ProgressBar, TextInput, Textarea } from "@devdigest/ui";
    ...
    <div style={s.card(candidate.status)}>
      <div style={s.cardMain}>
        <div style={s.cardTitleRow}>
          {selectable && (
            <Checkbox checked={selected} onChange={(v) => onSelect?.(v)} label={t("card.includeInSkill")} />
          )}
            ...
            <div style={s.evidence}>
              <div style={s.evidenceHeader}>
                {evidenceHref ? (
                  ...
                  <span className="mono">{evidenceLabel(candidate.evidence_path, candidate.evidence_line)}</span>
                )}
              </div>
