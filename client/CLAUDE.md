...
`pnpm-lock.yaml` · `src/vendor/shared/` (copy; edit the server one and sync) · `src/vendor/ui/` unless the task is about the design system · `.next/`. Full list in the root `CLAUDE.md`.

## Read when relevant

- `README.md` · `src/vendor/ui/README.md` · `docs/` · `specs/` · `INSIGHTS.md`
