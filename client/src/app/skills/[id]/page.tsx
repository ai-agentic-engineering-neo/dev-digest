/* /skills/:id — Skill Editor. Left rail reuses SkillCard (list of all
   skills, current one highlighted); right pane = SkillEditor. Tab state
   lives in ?tab=. Mirrors /agents/:id/page.tsx 1:1. */
"use client";

import React from "react";
import { useParams, useRouter, useSearchParams } from "next/navigation";
import { useTranslations } from "next-intl";
import { Button, Dropdown, ErrorState, Skeleton, Icon, Badge, Toggle } from "@devdigest/ui";
          ...
          <div style={{ padding: "16px 16px 12px" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 14 }}>
              ...
              <Dropdown
                ...
                items={[{ label: t("editor.createFromScratch"), icon: "Edit", onClick: () => router.push("/skills") }]}
              />
            </div>
          </div>
