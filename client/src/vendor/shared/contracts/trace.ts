...
export const RunStats = z.object({
  ...
  grounding: z.string(),
  // USD spend for the run; null when unknown (failed run, unpriced model,
  // traces written before cost was persisted).
...
export const RunSummary = z.object({
  ...
  // USD spend for the run; null when unknown or the run failed.
