...
| [engineering-insights](engineering-insights/SKILL.md) | Shared | Learnings loop: read per-package INSIGHTS.md before work, record verified lessons after (hand-authored, not vendored) |
